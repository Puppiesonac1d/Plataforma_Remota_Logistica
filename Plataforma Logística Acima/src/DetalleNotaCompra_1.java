 ...
 * @author The_S
 */
public class DetalleNotaCompra_1 extends javax.swing.JFrame {

    Conexion con = new Conexion();
    Connection cn = con.conecta();

    public DetalleNotaCompra_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Detalle de Nota de Compra");
        ...
        jLayeredPane1.add(lblFondoDetalle, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1280, 730));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleNotaCompra_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetalleNotaCompra_1().setVisible(true);
            }
        });
    }
